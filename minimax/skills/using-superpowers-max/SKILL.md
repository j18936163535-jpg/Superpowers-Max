...
description: Use when starting any conversation - establishes how to find and use skills with search discipline mandatory before any response, including clarifying questions; enforces web search before skill invocation to verify current best practice Search discipline is MANDATORY: see <MANDATORY_PREAMBLE> at top of this skill before any response.
---

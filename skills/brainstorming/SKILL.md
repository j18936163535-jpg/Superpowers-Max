---
name: brainstorming
description: "You MUST use this before any creative work - creating features, building components, adding functionality, or modifying behavior. Explores user intent, requirements and design before implementation. Enforces web search discipline before each design decision and at every step entry, so the design reflects current best practice rather than stale training data."
---
<SEARCH_DISCIPLINE>
# Search Triggers (硬触发)
